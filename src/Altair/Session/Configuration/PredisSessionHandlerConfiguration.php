...
class PredisSessionHandlerConfiguration implements ConfigurationInterface
{
    ...
    public function apply(Container $container): void
    {
        ...
        $container->bind(Client::class)->withParameters([
            'parameters' => $this->env->get('SESSION_REDIS_URI', 'tcp://127.0.0.1:6379'),
        ]);
        $container->alias(ClientInterface::class, Client::class);
        $container->alias(SessionHandlerInterface::class, PredisSessionHandler::class);
    }
}
